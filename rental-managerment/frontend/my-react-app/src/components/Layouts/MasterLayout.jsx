      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen relative">
        ...
        <header className="h-20 bg-white border-b border-slate-200 px-10 flex items-center justify-between sticky top-0 z-40 shadow-sm shadow-slate-100">
          ...
          <div className="relative w-full max-w-lg hidden md:block">
            ...
            <input
              type="text"
              placeholder="Tìm nhanh phòng, người thuê hoặc hợp đồng..."
              className="w-full bg-slate-50 border border-slate-100 rounded-xl py-2.5 pl-12 pr-4 text-sm font-semibold placeholder:text-slate-300 text-slate-600 focus:bg-white focus:ring-2 focus:ring-blue-500/10 focus:border-blue-500 transition-all outline-none"
            />
          </div>
            ...
            <div className="relative" ref={dropdownRef}>
              ...
              >
                <div className="text-right hidden sm:block">
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Chủ trọ</p>
                </div>
                <div className="relative">
                  <img
                    src={user.avatar || `https://ui-avatars.com/api/?name=${user.username}&background=0369a1&color=fff`}
                    alt="avatar"
                ...
                <div className="absolute right-0 mt-3 w-64 bg-white rounded-xl shadow-2xl shadow-slate-900/10 border border-slate-100 py-2 animate-in fade-in slide-in-from-top-2 duration-300 overflow-hidden">
                  ...
                  <div className="p-2 space-y-1">
                    <Link
                      ...
                      className="flex items-center gap-3 w-full p-4 rounded-lg text-slate-600 hover:bg-blue-50 hover:text-blue-600 transition-all font-bold text-sm"
                    >
